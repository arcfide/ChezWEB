...
\def\chunk#1#2#3#4{%
  ...
  \long\def\chunkimports{%
    \if\blank{#2}\else
      {\smallit Imports:} {\smalltt\raggedright #2\par}\fi}
  \long\def\chunkexports{%
    \if\blank{#3}\else
      {\smallit Exports:} {\smalltt\raggedright #3\par}\fi}
  \long\def\chunkcaptures{%
    \if\blank{#4}\else
      {\smallit Captures:} {\smalltt\raggedright #4\par}\fi}
  \definexref{#1}{\the\sectc}{chunkxref}
