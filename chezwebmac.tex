...
% Modified by Aaron W. Hsu for use in ChezWEB -- March 2010
...
\def\note#1#2.{\Y\noindent{\hangindent2em%
    \baselineskip10pt\eightrm#1~\ifacro%
    \everyverbatim={\smtt}%
    {\pdfnote#2.}\else#2\fi.\par}}
...
%%%%
%% Some macros that are special for ChezWEB

\font\smtt=cmtt8

\def\CAP{\note{This section captures}}% For the captures line.
\def\EXP{\note{This section exports}}% For the exports line.

%%%%
%% We setup the verbatim mode
...
%                         *vrblin200
%User macro
\def\verbatim{\begingroup%\preverbatim\begingroup
   \tt\setupverbatim
